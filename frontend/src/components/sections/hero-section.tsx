	...
	return (
		...
		>
			...
			<nav className="absolute top-0 left-0 right-0 p-6 flex justify-between items-center z-50">
				...
				<Link
					href="/login"
					className="px-4 py-2 rounded-full border border-foreground/20 hover:bg-foreground/5 transition-colors text-sm font-medium"
				>
					Login
				</Link>
			</nav>
			...
			>
				<h1 
					className="text-5xl md:text-7xl lg:text-8xl font-serif text-center text-white"
					style={{
