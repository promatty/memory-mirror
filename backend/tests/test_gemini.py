...
Run from backend directory: python -m tests.test_gemini
"""
...
def test_basic_generation():
    ...
    print("🤖 Testing Gemini Basic Generation...")
    print("-" * 50)
    ...
    try:
        ...
        # Generate response
        response = service.generate_simple_response(test_prompt)
...
def test_context_based_generation():
...
if __name__ == "__main__":
    ...
    results.append(("Context-Based Generation", test_context_based_generation()))
    results.append(("Memory Mirror Flow", test_memory_mirror_flow()))
